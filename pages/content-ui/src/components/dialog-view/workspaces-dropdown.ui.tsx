  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" sideOffset={8} className="w-[250px]">
          ...
          {workspaces?.items?.map(workspace => (
            <DropdownMenuRadioItem
              ...
              <Avatar className="hover:bg-primary h-8 w-8">
                ...
                />
                <AvatarFallback>
                  <span className="text-muted-foreground text-xs font-medium">{getInitials(workspace.name)}</span>
                </AvatarFallback>
              </Avatar>
        ...
        <DropdownMenuItem className="text-muted-foreground gap-x-2" onClick={handleOnCreateWorkspace}>
